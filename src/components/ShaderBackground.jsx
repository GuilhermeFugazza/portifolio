...
export default function ShaderBackground() {
  const camera = useMemo(
    () => ({ position: [0, 0, 1], fov: 75, near: 0.1, far: 1000 }),
    []
  );

  return (
    <div className="fixed inset-0 -z-10 h-full w-full pointer-events-none">
      <div className="absolute inset-0 scale-[1.02] blur-[6px]">
        <Canvas
          camera={camera}
      ...
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-night/40 via-transparent to-night/30" />
    </div>
  );
}
