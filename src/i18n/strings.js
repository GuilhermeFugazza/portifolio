...
export const strings = {
  ...
  footer: {
    ...
    place: { pt: "Balneário Camboriú, SC, Brasil", en: "Balneário Camboriú, SC, Brazil" }
  },
  common: {
  ...
  home: {
    eyebrow: { pt: "Full-stack Product Engineer · Balneário Camboriú, SC · Remoto", en: "Full-stack Product Engineer · Balneário Camboriú, SC, Brazil · Remote" },
    lede: {
  ...
  about: {
    ...
    facts: [
      ...
      { label: { pt: "Base", en: "Based in" }, value: { pt: "Balneário Camboriú, SC, Brasil", en: "Balneário Camboriú, SC, Brazil" } },
